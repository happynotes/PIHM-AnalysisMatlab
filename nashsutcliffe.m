...
%
function [NSout, metric_id, MatchedData] = nashsutcliffe(obsData, simData)
    ...
    if r >= 2 
        ...
        if NSout < 0
            ...
            disp('********************************************************************************************');
            disp('WARNING: nashsutcliffe');
            disp('model predictions are poor. Using the mean of observed data would be better.');
            disp('********************************************************************************************');

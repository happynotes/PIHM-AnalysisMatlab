...
list_pihm_output_titles = {'Interception Storage [m]',...
    ...
    'River Stage [m],'...
    'River Bed Storage [m],'...
    'Lateral influx to the stream reach [m^3/day],'...
    'Lateral outflow  to the stream reach [m^3/day],'...
    'Surface flow to stream reach from Left terrain [m^3/day],'...
    'Surface flow to stream reach from right terrain [m^3/day],'...
    'Baseflow to stream reach from aquifer on the left [m^3/day],'...
    'Baseflow to stream reach from aquifer on the right [m^3/day],'...
    'Leakage between stream reach and river bed [m^3/day],'...
    'Subsurface flow to the river bed from left aquifer [m^3/day],'...
    'Subsurface flow to the river bed from right aquifer [m^3/day],'... 
    'Lateral outflux to the bed beneath river [m^3/day],'};
